...
class Book extends REST_Controller
{
	...
	function bookValidate_post()
	{
		$book_id = $this->post('id_book');
		$admin_id = $this->post('id_admin');
		...
		{
			$ret = $this->book_model->bookValidate($book_id, $admin_id);

			if($ret == 0)
			{   
				 $message = [
				'id' => 0,
				'message' => 'Confirmed book validation'
				];
