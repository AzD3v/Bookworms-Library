<?php echo form_open("book/validate_bookValidate",'role="form" class="form-horizontal"');?>

<link rel="stylesheet" href="../../../assets/css/geral.css">

<div class="row">
    <div class="col col-lg-12">
        <h2>Validate a Book!</h2>
        <br>
    </div>
</div>
...
<div class="row">
    <div class="col-lg-12">
        <p class="text-center">
            <br>
            <button type="submit" class="btn btn-primary">Validate Book</button>
        </p>
    </div>
</div>
